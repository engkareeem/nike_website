         ...
         gap-10 max-container">
            <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
                ...
                <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-tight font-bold">
                    <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10 rounded-tr-[5rem] rounded-br-2xl">The New Arrival</span>
                    <br/>
            ...
            bg-cover bg-center">
                <img src={"https://www.allkeyshop.com/blog/wp-content/uploads/EldenRingShadowoftheErdtree.webp"} alt="Shoe collection" width={610} height={500}
